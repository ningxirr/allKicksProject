    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        ...
        <a
          ...
          href="/"
        >
          <img src="src/assets/allKicks.png" alt="Image" height="35" width="100" />
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex">
            <a class="nav-link" href="/cart">
              <i class="bi bi-bag-check-fill" style="font-size: 1.5rem; color: rgb(255, 255, 255);"></i>
            </a>
            <a
      ...
      <div class="container col-9" style="text-align : center;">
        <div class="row row-cols-1 row-cols-md-3 g-4">
          <div class="col" v-for="product_alias in filterProducts" v-bind:key="product_alias._id">
            <router-link
              :to="{ path: 'product', name: 'Product', params:{productId: product_alias._id} } "
              style="text-decoration : none;"
            >
              <div class="card text-dark bg-light mb-3 h-100 center" style="width: 18rem;">
                <br />
                <br />
                <img
    ...
    filterProducts: function() {
      return this.Products.filter(product => {
        return (
          ...
          product.description1.match(this.search) ||
          product.description2.match(this.search)
        );
      });
    }
  }
