<template>
  <div>
    ...
    <div class="container">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="navbar-brand flex-row float-left" href="/"><img src="src/assets/allKicks.png" alt="Image" height="35" width="100"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link " aria-current="page" href="/" style="padding-right:20px">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="/explore" style="padding-right:20px">Shop</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/aboutus" style="padding-right:20px">About us</a>
          </li>

        </ul>
        <form class="d-flex">
          
          <a class="nav-link" href="/cart"><i class="bi bi-bag-check-fill" style="font-size: 1.5rem; color: rgb(255, 255, 255); padding-right:10px"></i></a>
  ...
  <div>
      ...
      <div class="header">Find your favorite shoes</div>
